  ...
  return (
    <Flex gap="md" justify="center" direction="column">
      <Paper {...paperStyles}>
        ...
        <Flex gap="md" justify="space-evenly" direction="row">
          <Flex justify="flex-end" align="center" direction="column">
            ...
            <Divider w="100%" />
            <Text c={theme.colors.expense[5]}>{props.data.totalFiltered.expenses.toFixed(2)}€</Text>
          ...
          <Flex justify="center" align="center" direction="column">
            ...
            <Divider w="100%" />
            <Text c={theme.colors.income[5]}>{props.data.totalFiltered.income.toFixed(2)}€</Text>
            <Text c={theme.colors.remaining[5]}>{props.data.totalFiltered.remainingIncome.toFixed(2)}€</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="flex-end" align="center" direction="column">
            <Text>{props.dict.analysisPage.savings}</Text>
            <Divider w="100%" />
            <Text c={theme.colors.saving[5]}>{props.data.totalFiltered.savings.toFixed(2)}€</Text>
      ...
      <Paper {...paperStyles}>
        ...
        <Flex gap="md" justify="space-evenly" direction="row">
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.expense[5]}>{props.data.averagePerMonth.expenses.toFixed(2)}€</Text>
            <Text c={theme.colors.expense[5]}>{props.data.averagePerMonth.expensesPercentage.toFixed(2)}%</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.income[5]}>{props.data.averagePerMonth.income.toFixed(2)}€</Text>
            <Text c={theme.colors.remaining[5]}>{props.data.averagePerMonth.remainingIncome.toFixed(2)}€</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.saving[5]}>{props.data.averagePerMonth.savings.toFixed(2)}€</Text>
      ...
      <Paper {...paperStyles}>
        ...
        <Flex gap="md" justify="space-evenly" direction="row">
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.expense[5]}>{props.data.maximumOneMonth.expenses.toFixed(2)}€</Text>
            <Text c={theme.colors.expense[5]}>{props.data.maximumOneMonth.expensesPercentage.toFixed(2)}%</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.income[5]}>{props.data.maximumOneMonth.income.toFixed(2)}€</Text>
            <Text c={theme.colors.remaining[5]}>{props.data.maximumOneMonth.remainingIncome.toFixed(2)}€</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.saving[5]}>{props.data.maximumOneMonth.savings.toFixed(2)}€</Text>
      ...
      <Paper {...paperStyles}>
        ...
        <Flex gap="md" justify="space-evenly" direction="row">
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.expense[5]}>{props.data.minimumOneMonth.expenses.toFixed(2)}€</Text>
            <Text c={theme.colors.expense[5]}>{props.data.minimumOneMonth.expensesPercentage.toFixed(2)}%</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.income[5]}>{props.data.minimumOneMonth.income.toFixed(2)}€</Text>
            <Text c={theme.colors.remaining[5]}>{props.data.minimumOneMonth.remainingIncome.toFixed(2)}€</Text>
          </Flex>
          <Divider orientation="vertical" />
          <Flex justify="center" align="center" direction="column">
            <Text c={theme.colors.saving[5]}>{props.data.minimumOneMonth.savings.toFixed(2)}€</Text>
